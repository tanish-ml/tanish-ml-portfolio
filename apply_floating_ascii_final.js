...
// New floating ASCII rendering block (no backticks inside the inner script)
const newBlock = `// --- ASCII ART RENDERING (floating top-right) ---
const renderASCII = function() {
...
// Replace the old ASCII rendering block (identified by the comment line)
